...
const AuthPage = () => {
  const { user, isLoading, signIn, signUp, unlockVault, unlockWithPin, encryptedPinKey } = useAppStore();
  const [mode, setMode] = useState<'signin' | 'signup' | 'unlock' | 'pin'>('signin');
    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div className="auth-footer">
          <p>Your data is encrypted locally. Only you can access it.</p>
        </div>
      </div>
    </div>
  );
